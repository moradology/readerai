...
class QuestionAssessment(dspy.Signature):
    ...
    passage: str = dspy.InputField(description="A passage from a book or article.")
    question: str = dspy.InputField(description="A generated comprehension question.")
    relevance_score: float = dspy.OutputField(description="How relevant is the question? (0-1)")
    depth_score: float = dspy.OutputField(description="How deep or thought-provoking is the question? (0-1)")
    specificity_score: float = dspy.OutputField(description="How specific is the question? (0-1)")
