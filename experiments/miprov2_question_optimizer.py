...
optimized_answerability_assessor = answerability_optimizer.compile(
    student=answerability_assessor, trainset=assessment_examples, minibatch_size=1
)
...
optimized_question_assessor = quality_optimizer.compile(
    student=question_assessor, trainset=quality_examples, minibatch_size=1
)
...
optimized_question_predictor = question_optimizer.compile(
    student=question_predictor, trainset=question_gen_examples, minibatch_size=1
)
