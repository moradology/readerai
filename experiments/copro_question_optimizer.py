...
answerability_optimizer = dspy.COPRO(metric=answerability_training_metric, breadth=5, depth=2)
...
quality_optimizer = dspy.COPRO(metric=question_assessor_training_metric, breadth=5, depth=2)
...
question_optimizer = dspy.COPRO(metric=llm_based_question_metric, breadth=5, depth=3)
...
print("Optimization complete! The system is now using COPRO for prompt improvement.")
