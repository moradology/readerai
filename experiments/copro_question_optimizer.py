...
answerability_optimizer = dspy.COPRO(
    metric=answerability_training_metric, breadth=5, depth=2
)
...
quality_optimizer = dspy.COPRO(
    metric=question_assessor_training_metric, breadth=5, depth=2
)
